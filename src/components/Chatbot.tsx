    ...
    <div className="fixed bottom-6 right-6 z-50 font-sans">
      {isOpen ? (
        <div className="w-[360px] md:w-[400px] bg-white rounded-2xl shadow-2xl border border-gray-100 flex flex-col overflow-hidden transition-all duration-300 ease-in-out sm:max-h-[80vh] h-[600px]">
          {/* Header */}
          <div className="bg-blue-600 text-white px-5 py-4 flex justify-between items-center z-10 shadow-sm relative">
                    ...
                    <div className="mt-3 space-y-2">
                      {msg.products.map((product, idx) => (
                        <a 
                          ...
                          className="flex items-center space-x-3 bg-white border border-gray-100 rounded-xl p-2.5 hover:bg-gray-50 hover:border-blue-200 transition-all duration-200 group no-underline"
                        >
          ...
          <div className="px-4 py-3 bg-white border-t border-gray-100">
             <div className="flex items-center space-x-2 bg-gray-50/80 border border-gray-200 rounded-full px-2 py-1.5 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-100 focus-within:bg-white transition-all duration-200">
               <select
                 value={city}
               ...
               <button
                 ...
                 className={`rounded-full p-2 transition-colors flex-shrink-0 ${isListening ? 'bg-red-500 text-white animate-pulse' : 'bg-gray-200 text-gray-600 hover:bg-gray-300'} disabled:opacity-40`}
               ...
               <button
                 ...
                 className="bg-blue-600 text-white rounded-full p-2 hover:bg-blue-700 disabled:opacity-40 disabled:hover:bg-blue-600 transition-colors flex-shrink-0"
        ...
        <button
          ...
          className="bg-blue-600 shadow-lg shadow-blue-600/30 text-white p-4 rounded-full hover:bg-blue-700 hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-blue-400/50 flex items-center justify-center group"
